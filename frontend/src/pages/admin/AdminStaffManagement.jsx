          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-10">
            {loading ? (
              ...
              filteredStaff.map((member) => (
                <div key={member._id} className={`bg-white border border-[#E8DDCB] p-8 rounded-[3rem] shadow-sm group relative transition-all hover:border-[#FFA800] ${activeView === 'archived' ? 'grayscale opacity-80' : ''}`}>
                  <div className="flex justify-between items-start mb-6">
                    <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-2xl bg-[#FFFBF5] border border-[#E8DDCB]">
                  ...
                  <div className="pt-6 border-t border-[#E8DDCB]/50 flex items-center justify-between">
                    ...
                    <div className="flex gap-1">
                      {activeView === 'active' && (
                        <button onClick={() => handleArchive(member._id, member.name)} className="p-2.5 text-[#967A53] hover:text-red-500 hover:bg-red-50 rounded-xl transition-all">
                          <Archive size={16} />
                        </button>
                      )}
                      <button className="p-2.5 text-[#967A53] hover:text-[#FFA800] hover:bg-[#FFFBF5] rounded-xl transition-all">
                        <History size={16} />
                      </button>
                    </div>
                  </div>
